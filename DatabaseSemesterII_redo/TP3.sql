...
CREATE DATABASE IF NOT EXISTS `producttest_redo` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
Select * From customer_t Where state = "CA";
		#Ex3:
Select ID, description, standard_price From product_t Where finish LIKE "%ash";
		#Ex4:
Select product_t.* From product_t 
		Where finish LIKE "%ash" 
        AND (standard_price>=15 && standard_price<=80);
		#Ex5:
Select * From product_t Order By standard_price;
		#Ex6:
Select * From product_t JOIN order_t;
		#Ex7:
Select c.* From customer_t c JOIN order_t  o
		ON c.ID = o.customer_ID 
        Where order_date = "2004-04-01";
		#Ex8:
Select Distinct product_t.* From product_t Natural JOIN order_line_t 
Where order_ID = 106;
		#Ex9:
Select c.* From customer_t as c JOIN order_t as o
		ON c.ID = o.customer_ID Where o.ID = 106;
		#Ex10:
Select o.* From order_line_t as o JOIN product_t as t
		ON t.ID = o.product_ID 
...
Select o.* From order_line_t as o JOIN product_t as t
		...
		#Ex12:
Select o.* From order_line_t as o JOIN product_t as p
		ON p.ID = o.product_ID
        Where description = "book shelf" 
        UNION Select o.* From order_line_t as o JOIN product_t as p
		ON p.ID = o.product_ID
        Where description = "table lamp";
Select o.* From order_line_t as o JOIN product_t as p
		On p.ID = o.product_ID Where description = "book shelf"
        AND order_ID IN (Select order_ID From order_line_t as o1 JOIN product_t as p1
		On p1.ID = o1.product_ID Where description = "table lamp");
Select o.* From order_line_t as o JOIN product_t as p
		ON p.ID = o.product_ID Where description = "book shelf"
        AND order_ID NOT IN (Select order_ID From order_line_t o1 JOIN product_t as p1
        ON p1.ID = o1.product_ID Where description = "table lamp");
