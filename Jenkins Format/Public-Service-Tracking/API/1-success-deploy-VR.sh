...
MSG="<b>PROJECT</b>: Public Service Tracking SYSTEM%0A<b>APPLICATION</b>: API%0A<b>STATUS</b>: Success%0A<b>VERSION</b>: ${BUILD_NUMBER}%0A${Log}<b>Server</b>: DevAP-01%0A<b>Local IP</b>: 172.19.24.33%0A<b>Sub Domain</b>: <a href="https:dev-api-bank.mpwt.gov.kh">dev-api-bank.mpwt.gov.kh</a>"
