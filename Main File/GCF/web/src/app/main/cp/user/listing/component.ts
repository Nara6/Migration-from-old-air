...
export class UserComponent implements OnInit
{
     ...
     */
      ...
      //for table component
      @ViewChild('colCode', { static: true }) private colCode: TemplateRef<any>;
      ...
      lstColumnTableNames = ['លេខកូដ','រូបភាព','ពត៌មានអ្នកប្រើប្រាស់','សកម្មភាព'];
      columnTableInfo:any=[];
   ...
   /**
    ...
    createColumnTblName(){
      ...
      if(this.lstColumnTableNames && this.lstColumnTableNames.length){
          ...
          let lstTamplates = [ this.colCode,this.skuTpl,this.colInformation,this.colAction];
