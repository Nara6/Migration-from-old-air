...
export class RankComponent implements OnInit
{
     ...
     */
      ...
      @ViewChild('colnOfMember',{static:true}) private colnOfMember:TemplateRef<any>;
      
      lstColumnTableNames = ['រូបភាព','ឈ្មោះ','ចំនួនសមាជិក'];
      columnTableInfo:any=[];
   ...
   /**
    ...
    createColumnTblName(){
      ...
      if(this.lstColumnTableNames && this.lstColumnTableNames.length){
          ...
          let lstTamplates = [ this.skuTpl,this.colName,this.colnOfMember];
