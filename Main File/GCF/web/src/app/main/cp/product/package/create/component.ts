...
export class CreatePackageComponent implements OnInit {
    ...
    submit(){
        if(this.form.valid){
            ...
            this.service.addProducts(this.form.value).subscribe(res => {
                ...
                this.route.navigate([`cp/products/packages`]);
              }, err => {
                  this.isLoading = false;
    ...
    private _buildForm() {
        this.form = new FormGroup({
            ...
            product_id: new FormControl(this.data ? this.data.product_id : '', [Validators.required, Validators.maxLength(60)]),
            qty: new FormControl(this.data ? this.data.qty : '', [Validators.required, Validators.maxLength(60)]),
