...
export class Service {
    ...
    list(param_from_component): Observable<any> {
        ...
        return this.http.get<any>('/cp/products/packages', httpOptions); 
    }
    //==================================================================================>> List Student
    ...
    delete(id:number = 0): Observable<any> {
        return this.http
            .delete('/cp/products/packages/'+id, this.httpOptions);
    }
   ...
   //===========================================================================================================>> Get Setup date
    ...
    addProducts(data:any){
        return this.http.post<any>('/cp/products/package-products', data);
    }
}
