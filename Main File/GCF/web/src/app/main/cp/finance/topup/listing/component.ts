...
import { ViewPackageDialogComponent } from './view-product/component';
...
export class TopUpComponent implements OnInit
{
     ...
     */
      ...
      //for table component
      @ViewChild('skuTpl', { static: true }) private skuTpl: TemplateRef<any>;
      @ViewChild('colName',{static:true}) private colName:TemplateRef<any>;
      @ViewChild('colPv',{static:true}) private colPv:TemplateRef<any>;
      @ViewChild('colPrice',{static:true}) private colPrice:TemplateRef<any>;
      @ViewChild('colAction',{static:true}) private colAction:TemplateRef<any>;
      
      lstColumnTableNames = ['រូបភាព','ឈ្មោះកញ្ចប់','PV',​ 'តម្លៃ','សកម្មភាព'];
      columnTableInfo:any=[];
   ...
   /**
    ...
    createColumnTblName(){
      ...
      if(this.lstColumnTableNames && this.lstColumnTableNames.length){
          ...
          let lstTamplates = [ this.skuTpl,this.colName,this.colPv,this.colPrice,this.colAction];
    ...
    listing(params:any={}) {
      ...
      if (this.isSearching) {
        ...
        this._service.list(params).subscribe(res => {
          ...
          this.isLoadMore ? resMoreDatas = res : this.data = res;
    ...
    viewPackage(row:any = null):void {
      console.log(this.data);
      const dialogRef = this._dialog.open(ViewPackageDialogComponent, { data:row });
      dialogRef.afterClosed().subscribe((result) => { 
        //console.log(result); 
        if(result){    
          this.listing(); 
