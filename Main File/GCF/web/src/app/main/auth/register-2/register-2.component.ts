...
export class Register2Component implements OnInit {
    ...
    ngOnInit(): void{
      ...
      this.form = this.formBuilder.group({
        ref     : this.formBuilder.control('', [Validators.required, Validators.minLength(6),Validators.maxLength(64)]), 
        name     : this.formBuilder.control('', [Validators.required, Validators.minLength(6),Validators.maxLength(64)]), 
        email    : this.formBuilder.control('', [ Validators.email, Validators.pattern('^[a-z0-9._%+-]+@[a-z0-9.-]+\\.[a-z]{2,4}$') ]),
    ...
    //   this.uiService.loadingStateChanged.next(true);
        ...
        data.append('ref', this.form.get('ref').value);
