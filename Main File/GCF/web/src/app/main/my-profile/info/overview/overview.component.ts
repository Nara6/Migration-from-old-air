...
export class OverviewComponent implements OnInit, AfterViewInit {
    ...
    private _buildForm() {
        this.form = new FormGroup({
            ...
            phone: new FormControl(this.data.phone, [ Validators.pattern('(^[0][0-9].{7}$)|(^[0][0-9].{8}$)|(^[855][0-9].{9}$)|(^[855][0-9].{10}$)|(.+@.+\..+)') ]),
            email: new FormControl(this.data.email, [ Validators.email, Validators.pattern('^[a-z0-9._%+-]+@[a-z0-9.-]+\\.[a-z]{2,4}$') ]),
