...
export class ReferralComponent implements OnInit
{
     ...
     */
      ...
      @ViewChild('colPhone',{static:true}) private colPhone:TemplateRef<any>;
      @ViewChild('colDate',{static:true}) private colDate:TemplateRef<any>;
      
      lstColumnTableNames = ['UID','ឈ្មោះ', 'លេខទូរស័ព្ទ','តំណែង','កាលបរិច្ឆេទ'];
      columnTableInfo:any=[];
   ...
   /**
    ...
    createColumnTblName(){
      ...
      if(this.lstColumnTableNames && this.lstColumnTableNames.length){
          ...
          let lstTamplates = [ this.colNumber,this.colName,this.colPhone,this.colRank,this.colDate];
