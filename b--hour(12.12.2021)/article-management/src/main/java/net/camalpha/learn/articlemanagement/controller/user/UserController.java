...
public class UserController {
    ...
    @GetMapping
    public PageResponse<UserListView> list(
    ...
    @PostMapping
    public DataResponse<UserDetailView> create(
            @RequestBody UserCreateForm form
    ) {
        return this.userService.create(form);
    }

    @GetMapping("/{id}")
    public DataResponse<UserDetailView> get(
    ...
    @PatchMapping("/{id}")
    public DataResponse<UserDetailView> update(
            @PathVariable("id") Integer id,
    ...
    @DeleteMapping("/{id}")
    public DataResponse<UserDetailView> delete(
            @PathVariable("id") Integer id
    ) {
