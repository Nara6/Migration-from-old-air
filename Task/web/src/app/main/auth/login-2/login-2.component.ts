...
export class Login2Component implements OnInit {
    ...
    private _buildForm() {
        ...
        this.loginForm = new FormGroup({
            username: new FormControl(env.username, [ Validators.required ]),
            password: new FormControl(env.password, [ Validators.required, Validators.minLength(6), Validators.maxLength(20) ]),
